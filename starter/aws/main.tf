    ...
    "environment": [
      {
        ...
        "value": "udacity-munishgoyal-azure-sql"
      },
      {
        "name": "AZURE_DOTNET_APP",
        "value": "udacity-munishgoyal-azure-dotnet-app"
      }
    ],
    "portMappings": [
      {
...
resource "aws_s3_bucket" "b" {
  bucket = "udacity-munishgoyal-aws-s3-bucket"
...
resource "aws_s3_bucket_acl" "udacity" {
  bucket = aws_s3_bucket.b.id
  acl    = "private"
}

resource "aws_dynamodb_table" "basic-dynamodb-table" {
  name           = "udacity-munishgoyal-aws-dynamodb"
